...
- default argument - `bool full_name = true`
- function body - `return full_name ? p.full_name : p.full_name;`
...
**Your answer:**
Arguments pushed onto stack (can be put in registers) -> return address -> jump to function -> stack frame -> return value -> calling function reads from (eax/rax)
...
small types < 8 bytes and need a local copy.
